...
class MyJpanel extends JPanel implements MouseListener,ActionListener,ItemListener
{
   ...
   public static String firstName,lastName,dob,gender,address,pinCode,phoneNo,emailId,instituteName,branch,sem,year,scholarNo ;
   MyJpanel inner;
   int i;
   int x=0;
   int temp=0;
   ...
   MyJpanel(Container ct)
   {
    ...
    // jr3.setBackground(Color.cyan);  
     ...
     j1.setBounds((int)(scr.width/2.18),(int)(scr.height/1.59),(int)(scr.width/9.6),(int)(scr.height/21.6));//j1 back button
      imagelabel.setBounds((int)(scr.width/1.6)+150,(int)(scr.height/3.48),(int)(scr.width/10),(int)(scr.height/36));//image label
     jb.setBounds((int)(scr.width/1.4)+140,(int)(scr.height/3.48)+50,(int)(scr.width/15)+50,(int)(scr.height/33));//upload button
...
class Signinst extends JPanel implements ActionListener,MouseListener,ItemListener
{
     public JLabel []jl=new JLabel[21];
   public JTextField jtf[]=new JTextField[10];
   public JRadioButton jr1,jr2,jr3;
